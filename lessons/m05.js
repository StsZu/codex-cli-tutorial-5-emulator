  ...
  lessons: [
    {
      ...
      steps: [
        ...
        { type: "cli", title: "Спершу план, потім код",
          commands: [
            ...
            { cmd: "/review", explain: "Codex перевіряє робоче дерево: зміни поведінки, бракуючі тести. Можна з власними інструкціями: <code>/review Перевір обробку помилок</code>.", risk: "low" },
      ...
      quiz: [
        { question: "Чим `/review` відрізняється від `/diff`?", options: ["`/review` — оцінка змін агентом, `/diff` — самі рядки змін", "Нічим", "`/review` комітить зміни"], correct: 0, feedback: "Спершу `/diff` — що саме змінилося, потім `/review` — що в цих змінах може бути не так." },
